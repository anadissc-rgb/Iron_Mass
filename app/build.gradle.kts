...
android {
    ...
    defaultConfig {
        applicationId = "com.aistudio.ironmass.vzkfqr"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
    ...
    signingConfigs {
        ...
        val storePassEnv = System.getenv("STORE_PASSWORD")
        val keyPassEnv = System.getenv("KEY_PASSWORD")

        if (keystoreEnv != null && storePassEnv != null && keyPassEnv != null) {
            create("release") {
    ...
    buildTypes {
        ...
        debug {
            val hasDebugConfig = signingConfigs.names.contains("debugConfig")
            if (hasDebugConfig) {
